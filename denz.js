...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: 'ᴏɴʟʏ ғᴏʀ⁩ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎💝',
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 777888, "message": teks, "footerText": "*_© ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
               case 0: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ- ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎🙂"; break;
                case 1: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎🙂"; break;
                case 2: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ- ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎🙂"; break;
                case 3: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ- ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎🙂"; break;
                case 4: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ😊"; break;
                case 5: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ😊"; break;
                case 6: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ\n-ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎😊"; break;
            ...
            switch(jamss){
                ...
                case 4: jamss = "ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎🌚⁩"; break;
                case 5: jamss = "ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎🌚⁩"; break;
                ...
                case 12: jamss = "ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎⁩"; break;
                case 13: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🌝"; break;
                case 14: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🌝"; break;
                case 15: jamss = "ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎🙂⁩"; break;
                case 16: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🤠"; break;
                case 17: jamss = "ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ🌝"; break;
                case 18: jamss = "‍ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎👻"; break;
                case 19: jamss = "ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎🌚⁩"; break;
                case 20: jamss = "ɢᴏᴏᴅ ɴɪɢʜᴛ🥺"; break;
                case 21: jamss = "ɢᴏᴏᴅ ɴɪɢʜᴛ😞"; break;
                case 22: jamss = "ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎🙃⁩"; break;
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ī.ᴀᴍ/ʙᴇʟᴄᴏˢᵉʳ♔︎`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/918590508376?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'😱SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
case 'help':
case '?':
denz.sendMessage(from, 'ᴡᴀɪᴛ ᴍᴡᴏɴᴀ🎭', text, {quoted: ftok})
stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
data = fs.readFileSync('./lib/logo.js');
...
"listMessage":{
"title":"ʜʏ ᴅᴜᴅᴇ 🌞","description":`${""}

ᴥ︎︎︎ʜɪ  ${pushname}   

     ☆ *𝙸𝙽𝙵𝙾* ☆  
     
🌹ᴄʀᴇᴀᴛᴏʀ⟼ī.ᴀᴍ/␈ʙᴇʟᴄᴏˢᵉʳ♔︎
🌹ᴠᴇʀsɪᴏɴ⟼2.0
🌹ʙᴏᴛɴᴀᴍᴇ⟼ⁱᵗˢᵐᵉʙᴇʟᴄᴏˢᵉʳ☕︎
🌹ᴘʀᴇғɪx⟼(ᴍᴜʟᴛɪ ᴘʀᴇғɪx)
🌹sᴛᴀᴛᴜs⟼ ${publik ? 'ᴘᴜʙʟɪᴄ ɴᴏᴡ' : 'sᴇʟғ ɴᴏᴡ'} 
🌹ᴏᴡɴᴇʀ⟼ wa.me/919567941560  

     ☆ *𝚃𝙷𝙰𝙽𝙺𝚉* ☆
     
${tampilHari}
${" "}
   ʙʀᴏ ${pushname}  ᴄʟɪᴄᴋ ᴛᴏ ᴍᴇɴᴜ❣️
${""}
...
*╰─────────────────❋ཻུ۪۪⸙*`
katalog(menu)
sendButLocation(from, `${menu}`, "ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎⁩", {jpegThumbnail:gambar,name:""}, [{buttonId:`about`,buttonText:{displayText:'ᴀʙᴏᴜᴛ'},type:1},{buttonId:`donate`,buttonText:{displayText:'ᴅᴏɴᴀᴛᴇ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
		break
//My Api
       case 'maker2d2': 
...
╰───────────────𒈒
 ...
 `
     credit = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 8888888, "message": `${yez}`, "footerText": "©ī.ᴀᴍ/ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎", "thumbnail": fs.readFileSync('./denz.jpg'), "surface": 'CATALOG'}}, {quoted: mek})
...
break
		...
		try {
			  ...
			  break
case 'mode':
buttonss = [{buttonId: `public`, buttonText: {displayText: '𝗣𝗨𝗕𝗟𝗜𝗖۞'}, type: 1},{buttonId: `self`, buttonText: {displayText: '𝗦𝗘𝗟𝗙𝗘☹︎'}, type: 1}]
const buMess = {
    contentText: "𝗣𝗨𝗕𝗟𝗜𝗖☺︎︎-𝗦𝗘𝗟𝗙𝗘☹︎",
...
const btnbc = {
    ...
    footerText: '*_ʙʀᴏᴀᴅᴄᴀsᴛ ʙʏ ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎_*',
    buttons: buttonss,
    headerType: 1
}
...
└ ${prefix}ytmp4 [link yt] = Video`})
			...
			case 'ping':
				...
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					...
					denz.sendMessage(from, `ᴀᴅᴅᴇᴅ ᴛᴏ ɪᴍᴀɢᴇ ᴅᴀᴛᴀʙᴀsᴇ ʙʏ ī.ᴀᴍ/ʙᴇʟᴄᴏˢᵉʳ♔︎`, MessageType.text, { quoted: mek })
					break
				case 'delimage':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					try {
...
┃𒈒 *ɴᴀᴍᴇ ʙᴏᴛ* : 
ī.am/☦︎ʙᴇʟᴄᴏ-sᴇʀ☕︎
┃𒈒 *ɴᴀᴍᴇ ᴏᴡɴᴇʀ* : ꪶꪀ 𝓲 ꫝ ꪖ ꪶ ꫂ⁩
┃𒈒 *ᴄʀᴇᴀᴛᴏʀ* : wa.me/91963368766
┃𒈒 *sᴘᴇᴇᴅ* : 00065
┗━━𒆜
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ᴇʀʀᴏʀ-ᴀʟᴇʀᴛ* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ī.am/␈ʙᴇʟᴄᴏˢᵉʳ♔︎",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/919567941560?text=ʜʏ ʙʀᴏ"}}})
	}
    }
    }
    }
